          ...
          <div className="flex flex-col items-start justify-center h-full">
            ...
            <ul className="flex flex-col gap-4 mt-3">
              <li className="clamp4">
                ...
                до электромонтажа в готовом здании. «EXPRESS AUTOMATIUCA»
              ...
              <li className="clamp4">
                <strong>Сотрудничество. </strong> Компания «EXPRESS AUTOMATIUCA»
              ...
              <li className="clamp4">
                ...
                зданий. В «EXPRESS AUTOMATIUCA» можно заказать благоустройство
